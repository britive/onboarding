...
def main():
    ...
    custom_role_privileges = [
        ...
        {
            'privilegeName': 'GROUP_READ',
            'serviceId': 'admin'
        },
        {
            'privilegeName': 'GROUP_UPDATE',
            'serviceId': 'admin'
        }
    ]

    custom_role = create_custom_role(service, customer_id, custom_role_name, custom_role_privileges)
