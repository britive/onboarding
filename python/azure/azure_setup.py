...
class AzureBritiveIntegration:
    ...
    def register_britive_app(self):
        ...
        password_credential = PasswordCredential(display_name="BritiveSecret")

        client_secret = self.graph_client.applications.create_password_credential(
            application.object_id, password_credential
        )
    ...
    def assign_permissions(self):
        ...
        custom_role_properties = RoleDefinition(
            ...
            ],  # Add all subscriptions or specific ones
        )
        ...
        self.auth_client.role_assignments.create(
            ...
            parameters={
                ...
                "principal_id": self.graph_client.applications.get(
                    self.tenant_id
                ).object_id,
            },
        )
    ...
    def assign_directory_permissions(self):
        ...
        application = self.graph_client.applications.list(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--app",
        action="store_true",
        help="Create Britive Application in Azure",
        default=True,
    )
    parser.add_argument(
        "-r",
    ...
    azure_britive = AzureBritiveIntegration(
